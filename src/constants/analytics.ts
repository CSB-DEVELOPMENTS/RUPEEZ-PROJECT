  ...
  groups: [
    {
      ...
      shareLabel: "39%",
      targets: [
        { id: "housing", label: "Housing", valueLabel: "LKR 80,000" },
        { id: "food", label: "Food", valueLabel: "LKR 61,000" },
        { id: "transport", label: "Transport", valueLabel: "LKR 32,000" },
        { id: "utilities", label: "Utilities", valueLabel: "LKR 17,000" },
      ],
      tone: "brand",
      valueLabel: "LKR 190,000",
    },
    {
      id: "wants",
      label: "Wants",
      shareLabel: "15%",
      targets: [{ id: "others", label: "Others", valueLabel: "LKR 72,000" }],
      tone: "neutral",
      valueLabel: "LKR 72,000",
    },
    {
      id: "savings",
      label: "Savings",
      shareLabel: "29%",
      targets: [
        { id: "emergency", label: "Emergency", valueLabel: "LKR 80,000" },
        { id: "goals", label: "Goals", valueLabel: "LKR 63,000" },
      ],
      tone: "positive",
      valueLabel: "LKR 143,000",
    },
    {
      id: "investments",
      label: "Investments",
      shareLabel: "13%",
      targets: [
        { id: "stocks", label: "Stocks", valueLabel: "LKR 45,000" },
        { id: "crypto", label: "Crypto", valueLabel: "LKR 20,000" },
      ],
      tone: "teal",
      valueLabel: "LKR 65,000",
    },
    {
      id: "give",
      label: "Give",
      shareLabel: "3%",
      targets: [{ id: "charity", label: "Charity", valueLabel: "LKR 15,000" }],
      tone: "danger",
      valueLabel: "LKR 15,000",
    },
  ],
