...
function summaryToneClasses(tone: SubscriptionSummaryCardData["tone"]) {
  switch (tone) {
    case "positive":
      return {
        accent: "bg-app-primary/12",
        detail: "text-app-primary",
      };
    case "negative":
      return {
        accent: "bg-app-danger/10",
        detail: "text-app-danger",
      };
    case "brand":
      return {
        accent: "bg-app-brand/12",
        detail: "text-app-brand",
      };
    default:
      return {
        accent: "bg-app-panel/70",
        detail: "text-app-muted",
      };
  }
}
...
export function SubscriptionSummaryCard({ data }: { data: SubscriptionSummaryCardData }) {
  ...
  return (
    <DashboardCard className="min-h-[210px] overflow-hidden">
