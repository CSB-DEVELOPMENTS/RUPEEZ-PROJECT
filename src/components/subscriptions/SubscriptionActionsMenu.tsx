...
export function SubscriptionActionsMenu({
  ...
  return (
    <View className="absolute right-0 top-12 z-20 w-40 rounded-[24px] border border-app-border bg-app-surface p-2 shadow-showcase-soft">
      <Pressable className="flex-row items-center gap-3 rounded-2xl px-4 py-3" onPress={onEdit}>
      ...
      <Pressable className="flex-row items-center gap-3 rounded-2xl px-4 py-3" onPress={onDelete}>
